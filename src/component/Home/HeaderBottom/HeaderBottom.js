                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 bal">
                        <div className="main-content">
                            ...
                            <p>When interacting with customers- we strive to make sure that we present an experience ensuring their satisfaction. Our goal is to keep the customers happy and regularly coming back.</p>
